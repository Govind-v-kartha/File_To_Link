...
class OFAViT(nn.Module):
    ...
    def __init__(self, img_size=128, patch_size=16, drop_rate=0.,
...
def vit_base_patch16_8(**kwargs):
    model = OFAViT(
        patch_size=8, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, resize=8,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model
